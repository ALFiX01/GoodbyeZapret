...
rem set YTDB_CFUNBAN=3 --ipset="%~dp0lists\cloudflare-ipset.txt" --ipset-exclude-ip=1.1.1.1, 1.0.0.1, 212.109.195.93, 83.220.169.155, 141.105.71.21, 18.244.96.0/19, 18.244.128.0/19 --dpi-desync=multisplit --dpi-desync-split-seqovl=317 --dpi-desync-split-seqovl-pattern="%~dp0fake\tls_clienthello_16.bin" --dpi-desync-split-pos=sld+1 --dup=2 --dup-cutoff=n3
