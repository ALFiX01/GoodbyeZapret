...
def generate_bat_file(args, data):
    ...
    lines.append(BATCH_INFO_TEMPLATE.format(cdn_level=args.cdn_level, version=VERSION))
...
def main():
    ...
    if args.get_limits:
        ...
        generate_bat_file(args, data)
        save_user_config(args)
