...
set "LIST_TITLE=GoodbyeZapret: YouTubeFix ALT MGTS"
...
--filter-tcp=80 --hostlist="%LISTS_FOLDER%\list-youtube.txt" --dpi-desync=fake --dpi-desync-autottl=2 --dpi-desync-fooling=md5sig --new ^
--filter-tcp=443 --hostlist="%LISTS_FOLDER%\list-youtube.txt" --dpi-desync=fake --dpi-desync-autottl=2 --dpi-desync-repeats=6 --dpi-desync-fooling=badseq --dpi-desync-fake-tls="%BIN%tls_clienthello_www_google_com.bin"