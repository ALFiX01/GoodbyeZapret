...
set "CONFIG_NAME=GoodbyeZapret: UltimateFix"
...
--filter-tcp=443 --hostlist="%LISTS%russia-blacklist.txt" --dpi-desync=fake,split --dpi-desync-autottl=2 --dpi-desync-repeats=6 --dpi-desync-fooling=badseq --dpi-desync-fake-tls="%BIN%tls_clienthello_www_google_com.bin" ^
