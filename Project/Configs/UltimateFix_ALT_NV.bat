...
set "LIST_TITLE=GoodbyeZapret: Ultimate Fix NV TCP 80"
...
--filter-tcp=443 --hostlist="%LISTS_FOLDER%\discord.txt" --dpi-desync=fake,split2 --dpi-desync-split-seqovl=1 --dpi-desync-split-tls=sniext --dpi-desync-fake-tls="%BIN%tls_clienthello_2.bin" --dpi-desync-ttl=2 --new ^
