...
--filter-tcp=443 --ipset="%LISTS%russia-youtube-rtmps.txt" --dpi-desync=syndata,multisplit --dpi-desync-fake-syndata="%BIN%tls_clienthello_4.bin" --dpi-desync-split-pos=1 --new ^
