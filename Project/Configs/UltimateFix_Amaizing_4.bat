...
--filter-tcp=443 --hostlist="%LISTS%list-youtube.txt" --filter-l7=quic --dpi-desync=fake --dpi-desync-repeats=20 --dpi-desync-fake-quic="%BIN%quic_initial_www_google_com.bin" --new ^
--filter-tcp=443 --hostlist="%LISTS%custom-hostlist.txt" --filter-l7=quic --dpi-desync=fake --dpi-desync-repeats=20 --dpi-desync-fake-quic="%BIN%quic_initial_www_google_com.bin" --new ^
...
--filter-udp=443 --ipset="%LISTS%russia-youtube-rtmps.txt" --hostlist="%LISTS%youtubeQ.txt" --filter-l7=quic --dpi-desync=fake --dpi-desync-repeats=20 --dpi-desync-fake-quic="%BIN%quic_initial_www_google_com.bin" --new ^
--filter-tcp=443 --hostlist="%LISTS%faceinsta.txt" --filter-l7=quic --dpi-desync=fake --dpi-desync-repeats=20 --dpi-desync-fake-quic="%BIN%quic_initial_www_google_com.bin" --new ^
--filter-udp=443 --ipset="%LISTS%ipset-cloudflare.txt" --filter-l7=quic --dpi-desync=fake --dpi-desync-repeats=20 --dpi-desync-fake-quic="%BIN%quic_initial_www_google_com.bin" --hostlist-exclude="%LISTS%exclude.txt" --new ^
...
--filter-tcp=443 --hostlist-auto="%LISTS%autohostlist.txt" --hostlist-exclude="%LISTS%exclude-autohostlist.txt" --filter-l7=quic --dpi-desync=fake --dpi-desync-repeats=20 --dpi-desync-fake-quic="%BIN%quic_initial_www_google_com.bin" --new ^
