...
set "CONFIG_NAME=GoodbyeZapret: UltimateFix Amaizing TEST 2"
...
--filter-tcp=443 --ipset="%LISTS%russia-youtube-rtmps.txt" --dpi-desync=syndata --dpi-desync-fake-syndata="%FAKE%tls_clienthello_5.bin" --dup=2 --dup-cutoff=n3 --new ^
