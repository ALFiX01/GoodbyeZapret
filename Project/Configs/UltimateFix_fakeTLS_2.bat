...
set "CONFIG_NAME=GoodbyeZapret: UltimateFix fakeTLS 2"
...
--filter-tcp=443 --hostlist="%LISTS%russia-blacklist.txt" --dpi-desync=fake --dpi-desync-fooling=md5sig --dpi-desync-fake-tls-mod=rnd,rndsni,padencap --new ^
