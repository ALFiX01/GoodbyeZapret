...
set "LIST_TITLE=GoodbyeZapret: UltimateFix fakeTLS ALT"
set "DISCORD_IPSET=%parentDir%lists\ipset-discord.txt"
...
--filter-udp=50000-50100 --ipset="%DISCORD_IPSET%" --dpi-desync=fake --dpi-desync-any-protocol --dpi-desync-cutoff=d3 --dpi-desync-repeats=6 --new ^
...
--filter-tcp=443 --hostlist="%LISTS_FOLDER%\list-general.txt" --dpi-desync=fake --dpi-desync-fooling=md5sig --dpi-desync-fake-tls-mod=rnd,rndsni,padencap --new ^
