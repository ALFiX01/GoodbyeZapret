...
set "LIST_TITLE=GoodbyeZapret: UltimateFix split-badseq"
...
--filter-tcp=443 --hostlist="%LISTS_FOLDER%\youtube.txt" --dpi-desync=fake,split --dpi-desync-fooling=badseq --dpi-desync-repeats=6 --dpi-desync-fake-tls="%BIN%\tls_clienthello_www_google_com.bin" --new ^
