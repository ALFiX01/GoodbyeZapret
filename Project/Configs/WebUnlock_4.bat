...
--filter-tcp=80 --hostlist="%LISTS_FOLDER%\discord.txt" --dpi-desync=fake,split2 --dpi-desync-fooling=md5sig --dpi-desync-repeats=10 --dpi-desync-fake-tls="%BIN%\tls_clienthello_www_google_com.bin" --new ^
--filter-udp=443 --hostlist="%LISTS_FOLDER%\discord.txt" --dpi-desync=fake,split2 --dpi-desync-repeats=10 --dpi-desync-fake-quic="%BIN%\quic_1.bin" --new ^
