...
--filter-udp=443 --hostlist="%LISTS%discord.txt" --dpi-desync=fake --dpi-desync-udplen-increment=10 --dpi-desync-repeats=7 --dpi-desync-udplen-pattern=0xDEADBEEF --dpi-desync-fake-quic="%FAKE%quic_initial_www_google_com.bin" --new ^
