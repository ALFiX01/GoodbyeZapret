...
--filter-tcp=80,443-65535 --hostlist="%LISTS%list-amazon.txt" --out-range=-n8 --lua-desync=send:repeats=2 --lua-desync=syndata:blob=tls_google:ip_autottl=-2,3-20 --lua-desync=hostfakesplit:host=ozon.ru:tcp_ts=-1000:tcp_md5:repeats=4 --new ^
--filter-udp=443-65535 --hostlist="%LISTS%list-amazon.txt" --out-range=-n2 --payload=all --lua-desync=fake:blob=quic_google:repeats=4
