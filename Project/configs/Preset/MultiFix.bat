...
--filter-tcp=80,443,2053,2083,2087,2096,8443 --hostlist="%LISTS%list-discord.txt" --dpi-desync-any-protocol=1 --dpi-desync=multidisorder --dpi-desync-split-pos=1,midsld --dpi-desync-cutoff=n4 --new ^
