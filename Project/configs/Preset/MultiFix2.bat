...
--filter-tcp=443 --hostlist="%LISTS%list-youtube.txt" --dpi-desync-any-protocol=1 --dpi-desync=multisplit --dpi-desync-split-pos=7 --dpi-desync-split-seqovl=1 --dpi-desync-cutoff=n2 --new ^
--filter-tcp=80 --hostlist="%LISTS%russia-discord.txt" --dpi-desync-any-protocol=1 --dpi-desync=fakedsplit --dpi-desync-ttl=1 --dpi-desync-autottl=-1 --dpi-desync-split-pos=1 --dpi-desync-cutoff=n3 --new ^
