...
--filter-tcp=443 --hostlist="%LISTS%list-youtube.txt" --dpi-desync-any-protocol=1 --dpi-desync=multisplit --dpi-desync-split-pos=10 --dpi-desync-split-seqovl=1 --dpi-desync-cutoff=n3 --new ^
--filter-tcp=80 --hostlist="%LISTS%russia-discord.txt" --hostlist-domains=stable.dl2.discordapp.net,cdn77.com --dpi-desync-any-protocol=1 --dpi-desync=fakedsplit --dpi-desync-ttl=1 --dpi-desync-autottl=-1 --dpi-desync-split-pos=1 --dpi-desync-cutoff=n3 --new ^
