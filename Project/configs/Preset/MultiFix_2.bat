...
REM --filter-tcp=443 --hostlist="%LISTS%list-youtube.txt" --dpi-desync-any-protocol --dpi-desync=multisplit --dpi-desync-split-pos=7 --dpi-desync-split-seqovl=1 --dpi-desync-cutoff=n2 --new ^
