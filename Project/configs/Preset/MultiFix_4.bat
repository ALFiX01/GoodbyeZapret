...
--filter-tcp=443 --ipset="%LISTS%ipset-cloudflare-base.txt" --dpi-desync-any-protocol=1 --dpi-desync=fake,multidisorder --dpi-desync-split-pos=7,sld+1 --dpi-desync-fake-tls=0x0F0F0F0F --dpi-desync-fake-tls="%FAKE%tls_clienthello_4.bin" --dpi-desync-fake-tls-mod=rnd,dupsid,sni=fonts.google.com --dpi-desync-fooling=badseq --dpi-desync-cutoff=n3 --new ^
--filter-udp=443,444-65535 --ipset="%LISTS%ipset-cloudflare-base.txt" --dpi-desync=fake --dpi-desync-repeats=6 --dpi-desync-fake-quic="%FAKE%quic_initial_www_google_com.bin" --new ^
