...
--filter-udp=443 --hostlist-exclude="%LISTS%russia-discord.txt" --dpi-desync=fake,ipfrag2 --dpi-desync-fake-quic="%FAKE%fake_quic_4.bin" --dpi-desync-repeats=2 --dpi-desync-cutoff=n3 --new ^
