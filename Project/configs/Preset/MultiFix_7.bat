...
--wf-raw-part=@"%BIN%windivert.filter\windivert.battlefield.txt" ^
...
--filter-tcp=80,443,6568 --ipset="%LISTS%ipset-anydesk.txt" --dpi-desync=multisplit --dpi-desync-split-seqovl=224 --dpi-desync-split-seqovl-pattern="%FAKE%fake_tls_1.bin" --dpi-desync-cutoff=n4 --new ^
