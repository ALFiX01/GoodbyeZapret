...
--filter-tcp=443 --hostlist="%LISTS%list-discord.txt" --dpi-desync-any-protocol=1 --dpi-desync=multisplit --dpi-desync-split-seqovl=224 --dpi-desync-split-seqovl-pattern="%FAKE%fake_tls_1.bin" --dpi-desync-cutoff=n4 --new ^
--filter-l3=ipv6 --filter-tcp=443 --hostlist="%LISTS%list-discord.txt" --dpi-desync=fake,fakedsplit --dpi-desync-fake-tls=0x0F0F0F0F --dpi-desync-split-pos=1,sld+1 --dpi-desync-fakedsplit-pattern="%FAKE%fake_tls_2.bin" --dpi-desync-fakedsplit-mod=altorder=0 --dpi-desync-fooling=ts,badseq --dpi-desync-badseq-increment=10000000 --dpi-desync-cutoff=n5 --new ^
