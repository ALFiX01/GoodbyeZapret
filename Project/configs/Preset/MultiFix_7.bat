...
--dpi-desync=fake --dpi-desync-any-protocol --dpi-desync-autottl=2 --dpi-desync-repeats=7 --dpi-desync-fake-unknown-udp="%BIN%quic_initial_www_google_com.bin" --dpi-desync-cutoff=n2
...
--filter-tcp=443 --filter-l7=unknown --ipset="%LISTS%russia-youtube-rtmps.txt" --dpi-desync-any-protocol --dpi-desync=syndata --dpi-desync-fake-syndata="%FAKE%fake_syndata.bin" --dpi-desync-cutoff=n3 --new ^
...
--filter-tcp=443 --hostlist="%LISTS%russia-discord.txt" --dpi-desync-any-protocol --dpi-desync=multisplit --dpi-desync-split-seqovl=224 --dpi-desync-split-seqovl-pattern="%FAKE%fake_tls_1.bin" --dpi-desync-cutoff=n4 --new ^
