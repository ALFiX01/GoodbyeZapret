...
--wf-tcp=80,443,2053,2083,2087,2096 --wf-udp=443,50000-50090,4 ^
...
--filter-tcp=443 --hostlist="%LISTS%russia-discord.txt" --dpi-desync=fake,multisplit --dpi-desync-fake-tls=0x00F0000F --dpi-desync-fake-tls="%FAKE%fake_tls_7.bin" --dpi-desync-fake-tls-mod=rnd,dupsid --dpi-desync-fooling=ts,badseq --dpi-desync-cutoff=n5 --new ^
...
--filter-tcp=443 --ipset="%LISTS%ipset-cloudflare3.txt" --dpi-desync=fake,multisplit --dpi-desync-split-pos=1,sld+1 --dpi-desync-fake-tls=0x0F0F0F0F --dpi-desync-fake-tls="%FAKE%fake_tls_3.bin" --dpi-desync-fake-tls-mod=rnd,dupsid,rndsni --dpi-desync-fooling=ts,badseq --dpi-desync-cutoff=n5 --new ^
