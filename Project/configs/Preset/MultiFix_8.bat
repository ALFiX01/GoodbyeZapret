...
--filter-l3=ipv6 --filter-tcp=443 --hostlist="%LISTS%list-discord.txt" --dpi-desync=fake,multisplit --dpi-desync-fake-tls=0x00F0000F --dpi-desync-fake-tls="%FAKE%fake_tls_7.bin" --dpi-desync-fake-tls-mod=rnd,dupsid --dpi-desync-fooling=ts,badseq --dpi-desync-cutoff=n5 --new ^
