...
--ipcache-hostname=1 --ipcache-lifetime=0 --filter-tcp=443 --filter-l7=tls --hostlist="%LISTS%list-youtube.txt" --dpi-desync-any-protocol=1 --dpi-desync=fake,multidisorder --dpi-desync-split-pos=8,sld+1 --dpi-desync-fake-tls=0x0F0F0F0F --dpi-desync-fake-tls="%FAKE%tls_clienthello_max_ru.bin" --dpi-desync-fake-tls-mod=rnd,dupsid,rndsni,sni=fonts.google.com --dpi-desync-fooling=ts,badseq --dpi-desync-cutoff=n5 --new ^

--filter-tcp=80 --hostlist="%LISTS%list-discord.txt" --dpi-desync=fake,hostfakesplit --dpi-desync-fooling=md5sig --dup=1 --dup-cutoff=n2 --dup-fooling=md5sig --dpi-desync-hostfakesplit-mod=altorder=1 --dpi-desync-fake-tls="%FAKE%tls_clienthello_312.bin" --dpi-desync-fake-tls-mod=rnd,dupsid,rndsni,sni=www.google.com --new ^
--filter-tcp=443 --hostlist="%LISTS%list-discord.txt" --dpi-desync-any-protocol=1 --dpi-desync=multisplit --dpi-desync-split-seqovl=228 --dpi-desync-split-seqovl-pattern="%FAKE%tls_clienthello_312.bin" --dpi-desync-cutoff=n5 --new ^
