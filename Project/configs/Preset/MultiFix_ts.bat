...
--wf-tcp=80,443,1080,2053,2083,2087,2096,8443 --wf-udp=443,444-65535 ^
...
--filter-tcp=443 --hostlist="%LISTS%list-youtube.txt" --dpi-desync=fakedsplit --dpi-desync-fakedsplit-mod=altorder=2 --dpi-desync-fooling=ts --dpi-desync-split-pos=1 --new ^
...
--filter-tcp=80,443,1080,2053,2083,2087,2096,8443 --ipset="%LISTS%ipset-discord.txt" --dpi-desync=fake --dpi-desync-repeats=6 --dpi-desync-fooling=ts --dpi-desync-fake-tls="%FAKE%tls_clienthello_max_ru.bin" --new ^
--filter-tcp=443 --hostlist-domains=updates.discord.com --dpi-desync=fake --dpi-desync-repeats=6 --dpi-desync-fooling=ts --dpi-desync-fake-tls="%FAKE%tls_clienthello_max_ru.bin" --new ^
--filter-l7=discord,stun --dpi-desync=fake --dpi-desync-fooling=ts
...
--filter-tcp=443 --hostlist="%LISTS%russia-blacklist.txt" --hostlist="%LISTS%custom-hostlist.txt" --hostlist="%LISTS%mycdnlist.txt" --hostlist-exclude="%LISTS%list-youtube.txt" --dpi-desync=fake --dpi-desync-fooling=ts --new ^
...
--filter-tcp=80,443-65535 --ipset="%LISTS%ipset-cloudflare-%CDN_BypassLevel%.txt" --ipset-exclude="%LISTS%ipset-dns.txt" --dpi-desync=split2 --dpi-desync-split-seqovl=652 --dpi-desync-split-pos=2 --dpi-desync-split-seqovl-pattern="%FAKE%tls_clienthello_www_google_com.bin" --new ^
