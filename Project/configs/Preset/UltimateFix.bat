...
--filter-tcp=443,1024-65535 --ipset="%LISTS%ipset-cloudflare3.txt" --dpi-desync=fake,multidisorder --dpi-desync-split-pos=midsld --dpi-desync-repeats=6 --dpi-desync-fooling=md5sig,badseq --new ^
