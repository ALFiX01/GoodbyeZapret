...
> ⚠️ Также должен быть запущен **от имени администратора**.

### 🧱 2 способ

1. Скачайте свежий архив `GoodbyeZapret.zip` из [релизов](https://github.com/ALFiX01/GoodbyeZapret/releases/latest).
