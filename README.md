...
1. Скачайте архив [GoodbyeZapret.zip](https://github.com/ALFiX01/GoodbyeZapret/releases/latest).
2. Распакуйте архив на системный диск, например, `C:\GoodbyeZapret`  
   > ⚠️ По хорошему путь не должен содержать пробелов, специальных или кириллических символов.
