...
- [📌 О проекте](#-о-проекте)
- [⚠️ Важное предупреждение об антивирусах](#️-важное-предупреждение-об-антивирусах)
...
3. Проверьте, что путь к исполняемому файлу:  
   ...
   ```
4. Запустите `Launcher.exe` **от имени администратора**.
...
2. Удалите старое содержимое папки:
   ...
   ```
3. Распакуйте новый архив и запустите `Launcher.exe` от имени администратора.
...
### 🧹 Файлы удаляются или проблема с запуском Launcher.exe или конфигов
